...
},
{
            ...
            'evangelical and reformed church',
            'international council of community churches',
            'protestant reformed c       {controlName:'BooleanDropBox',html:'<div id="booleanDiv" class="btn-group"><button class="btn dropdown-toggle btn-mini" data-toggle="dropdown" href="#">'+
   ...
   getHtml:function(controlName){
    ...
    changeValues:function(row,arg){
        ...
        if (arg==='w'){
            ...
            if (row.rowValue.dropdownOne==='Number of Studies Started'){

                row.rowValue.dropdownOne = 'started_studies';
                row.rowValue.dropdownTwo = this.translateToXML('Number of Studies Started','2',row.rowValue.dropdownTwo);
                //row.rowValue.dropdownThree = 'i';
                //row.rowValue.dropdownTwo = 'eq';
        ...
        if (arg==='r'){
            ...
            if (row.rowValue.dropdownOne === 'started_studies'){
                ...
                row.rowValue.dropdownOne = 'Number of Studies Started';
                row.rowValue.dropdownTwo = this.translateFromXML('started_studies','2',row.rowValue.dropdownTwo);
                //row.rowValue.dropdownThree = 
            }
    ...
    changeStudyW:function(){
        ...
        for(var i=0;i<rows.length;i++){
            ...
            if (rows[i].rowValue.dropdownOne === 'Exclude Study' || rows[i].rowValue.dropdownOne==='Number of Studies Started'){
    ...
    changeStudyR:function(){
        ...
        for(var i=0;i<rows.length;i++){
            ...
            if (this.isStudy(rows[i])){
                ...
                if ((rows[i].rowValue.dropdownOne!='started_studies')) rows[i].cType='label';
